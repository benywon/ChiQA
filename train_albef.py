            ...
            with open(filepath, 'r', encoding='utf-8') as f:
                for line in f:
                    ...
                    if len(data_list) >= args.batch_size:
                        ...
                        batch = collect_qpic_data(batch, tokenizer_thread)
...
def run():
    ...
    global args, global_step, tokenizer
    ...
    model = ALBEF(config=config, text_encoder=args.text_encoder_model, tokenizer=tokenizer, init_deit=True)
    dist.barrier()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--load-model-path', type=str, default='./save_checkpoints/albef_models/checkpoint-best.pt')
    parser.add_argument('--model-save-directory', type=str, default='./save_checkpoints/albef_models')
    ...
    parser.add_argument('--tensorboard-dir', type=str, default='./logs/albef_models')
