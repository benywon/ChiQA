...
if __name__ == "__main__":
    ...
    parser.add_argument('--load-model-path', type=str, default='./save_checkpoints/bert_base_detr_models/checkpoint-best.pt')
    parser.add_argument('--model-save-directory', type=str, default='./save_checkpoints/bert_base_detr_models')
    ...
    parser.add_argument('--tensorboard-dir', type=str, default='./logs/bert_base_detr_models')
    ...
    parser.add_argument('--train-loader-size', type=int, default=800, help='train loader size')
    parser.add_argument('--save-steps', type=int, default=200, help='save model steps')
